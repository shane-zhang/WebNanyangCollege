<?php return array (
  ...
  array (
    ...
    'templates|makesi|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|makesi|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|makesi|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|makesi|wap' => 
    array (
    ...
    'templates|makesi|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|makesi|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|makesi|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|makesi|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|makesi|yp' => 
    ...
    'templates|makesi|yp|com_default' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|makesi|comment' => 
    array (
